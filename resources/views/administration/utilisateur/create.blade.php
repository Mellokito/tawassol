    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Ajouter utilisateur</span>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="m-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            action="{{route('utilisateur.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Portlet-->
                                ...
                                <div class="col-xl-6">
                                        <div class="m-form__section m-form__section--first">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <input class="form-control m-input" type="password" name="password" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <select class="form-control m-input" name="role">
                                                        ...
                                                        <option value="{{ $role->id }}">{{ $role->nom_profil }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
